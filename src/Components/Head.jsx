    ...
    return(
        <>
            <header className="fixed h-20 left-0 w-full opacity-100 bg-white top-0 z-[300]">
                <div
                    className="w-full h-full py-3 grid grid-cols-header-small md:grid-cols-header-medium lg:grid-cols-header-large md:gap-12 items-center justify-between px-3 md:px-5 lg:px-9 shadow-sh-112-8">
                    <a className="ps-3 lg:w-52 !h-[56px] !w-[124px] flex items-center justify-start" href="">
                        <div className="hidden md:flex md:items-center md:justify-center"><img src={logo} width="224"
                            height="140" className="lg:w-52" loading="eager" alt="RDVanytime" /></div>
                        <div className="block md:hidden max-w-[32px] max-h-[32px]"><img src={logo}
                            loading="eager" className="max-w-[32px] max-h-[32px]" alt="RDVanytime" /></div>
                    </a>
                    ...
                    <div className="flex justify-end">
                        <div className="w-full grid gap-2 items-center justify-end grid-flow-col auto-flow-max">
                            <div><button id="lang-switcher" aria-label="language-switcher"
