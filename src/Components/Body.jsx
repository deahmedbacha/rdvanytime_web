                              ...
                              {showDiv1 && (
                                ...
                                >
                                  <div className="max-h-80 overflow-y-auto px-3 flex flex-col min-h-[max-content] ">
                                    ...
                                    <button className="grid grid-cols-speciality-item gap-2 items-center justify-between w-full rounded-lg py-5 px-4 cursor-pointer hover:bg-primary-ice group">
                                      <div
                                        className="min-w-[26px] min-h-[26px]"
                                        style={{
                                          loading: "eager",
